...
def create_user(**paramns):
    """Create and return a new user."""
    return get_user_model().objects.create_user(**paramns)
...
class PrivateRecipeApiTests(TestCase):
    """Testa authenticated API requests."""
    ...
    def test_recipe_list_limited_to_user(self):
        """Test list of recipes is limited to authentivated user."""
    ...
    def test_full_update(self):
        ...
        recipe = create_recipe(
            user=self.user,
            title='Sample recipe title',
            link='https://iadevlab.com/post/4',
    ...
    def test_clear_recipe_tags(self):
        ...
        tag = Tag.objects.create(user=self.user, name='Desset')
        recipe = create_recipe(user=self.user)
        recipe.tags.add(tag)
